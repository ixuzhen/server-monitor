...
public class MybaitsPlus {
    ...
    @Test
    void generator() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3307/lottery_01", "root",
                        "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("cn.itedus.lottery.po") // 设置父包名
                            .moduleName("lottery-infrastructure") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "E:\\Desktop\\xz")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("mq_message")// 设置需要生成的表名
