...
import { API, LoginAPI } from '../../request/index';
      ...
      <div style={{margin: "0 auto", color: "rgb(140, 146, 164)", textAlign: "center", fontSize:"14px"}}>
        ...
        <div style={{display: "flex", marginTop:"20px", paddingLeft:"20px"}}>
          <div onClick={handleGitHubLogin} style={{flex:1, margin: "0 auto",}} className="otherLoginSpanCenter" >
            <span >
            <svg t="1692888905361" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="otherLoginSpanCenter" style={{flex:1, margin: "0 auto"}} >
            <span >
